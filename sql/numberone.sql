...
insert into sys_menu values('116',  '设备管理', '1', '10', '/system/equipmentInfo',        'C', '0', 'system:equipmentInfo:view',         '#', 'admin', '2019-04-24 11-33-00', 'ry', '2019-04-24 11-33-00', '设备管理菜单');
-- 三级菜单
...
-- 设备管理按钮
insert into sys_menu values('1058', '设备查询', '116', '1',  '#',  'F', '0', 'system:equipmentInfo:list',        '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '');
insert into sys_menu values('1059', '设备新增', '116', '2',  '#',  'F', '0', 'system:equipmentInfo:add',         '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '');
insert into sys_menu values('1060', '设备修改', '116', '3',  '#',  'F', '0', 'system:equipmentInfo:edit',        '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '');
insert into sys_menu values('1061', '设备删除', '116', '4',  '#',  'F', '0', 'system:equipmentInfo:remove',      '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '');
insert into sys_menu values('1062', '设备导出', '116', '5',  '#',  'F', '0', 'system:equipmentInfo:export',      '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '');
insert into sys_menu values('1063', '用户导入', '116', '6',  '#',  'F', '0', 'system:equipmentInfo:import',      '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '');
-- 在线用户按钮
...
-- 20190512
drop table if exists sys_machine_info;
create table sys_machine_info
(
    machine_info_id       int(11)         not null auto_increment    comment '设备id',
	machine_code     varchar(64)     not null                   comment '设备机器码',
	machine_type     varchar(16)     not null                   comment '设备类型',
	company_code     varchar(100)                        comment '公司编码',
	company_name     varchar(200)                       comment '公司名称',
	auth_deadline     datetime                            comment '授权期限',
	license     varchar(2000)                        comment '许可字符串',
	...
	update_time   datetime                                   comment '更新时间',
    remark 		  varchar(500) 	  default null 				 comment '备注',
	primary key (machine_info_id)
) engine=innodb default charset=utf8 comment = '设备信息表';

-- ----------------------------
-- 初始化-设备信息表数据
-- ----------------------------
insert into sys_machine_info values(1, 'machineCode',  'machinetype', 'companycode','公司名称',   114545465655656564,'license', 0, 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '备注');

insert into sys_menu values('117',  '设备管理NEW', '1', '10', '/system/machineInfo',        'C', '0', 'system:machineInfo:view',         '#', 'admin', '2019-04-24 11-33-00', 'ry', '2019-04-24 11-33-00', '设备管理菜单');

-- 设备管理按钮
insert into sys_menu values('1064', '设备查询', '117', '1',  '#',  'F', '0', 'system:machineInfo:list',        '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '');
insert into sys_menu values('1065', '设备新增', '117', '2',  '#',  'F', '0', 'system:machineInfo:add',         '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '');
insert into sys_menu values('1066', '设备修改', '117', '3',  '#',  'F', '0', 'system:machineInfo:edit',        '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '');
insert into sys_menu values('1067', '设备删除', '117', '4',  '#',  'F', '0', 'system:machineInfo:remove',      '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '');
insert into sys_menu values('1068', '设备导出', '117', '5',  '#',  'F', '0', 'system:machineInfo:export',      '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '');
insert into sys_menu values('1069', '设备导入', '117', '6',  '#',  'F', '0', 'system:machineInfo:import',      '#', 'admin', '2018-03-16 11-33-00', 'ry', '2018-03-16 11-33-00', '');
